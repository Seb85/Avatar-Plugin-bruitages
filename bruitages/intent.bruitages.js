...
exports.default = function (state, actions) {
	...
	var tokens = (0, _helpers.intersect)(Config.modules.bruitages.rules, state.tokens);

	if (tokens) {
		state.isIntent = true;
		if (state.debug) info('IntentBruitages'.bold.green, 'tokens:', tokens.toString().green);
